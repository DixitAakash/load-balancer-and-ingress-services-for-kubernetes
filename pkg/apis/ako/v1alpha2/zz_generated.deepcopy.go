...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AviCrdRef) DeepCopyInto(out *AviCrdRef) {
	*out = *in
	if in.Group != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AviCrdRef.
func (in *AviCrdRef) DeepCopy() *AviCrdRef {
	if in == nil {
		return nil
	}
	out := new(AviCrdRef)
...
func (in *BackendProperties) DeepCopyInto(out *BackendProperties) {
	*out = *in
	...
	if in.AviCrdRefs != nil {
		in, out := &in.AviCrdRefs, &out.AviCrdRefs
		*out = make([]*AviCrdRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AviCrdRef)
